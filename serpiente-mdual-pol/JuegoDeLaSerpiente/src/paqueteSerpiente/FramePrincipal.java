...
public class FramePrincipal extends JFrame{
	...
	public static void main(String[] args) {
		...
		framePrincipal = new FramePrincipal(20,20,30,30);
		framePrincipal.launch();
//		framePrincipal.getSnk().drawSnake(frame.getGraphics());
		framePrincipal.getSnk().drawSnake(framePrincipal.getGraphics());
		framePrincipal.getEgg().respawn();
		framePrincipal.getEgg().drawEgg(framePrincipal.getGraphics());
//		framePrincipal.getEgg().drawEgg(frame.getGraphics());
